...
Após a IA gerar uma paginação horizontal com todos os números de página enfileirados (criando barra de rolagem gigante em 251 páginas), reescrevi a função `getPaginationItems` manualmente: exibe as primeiras 25 páginas, reticências e a última página. Solução direta que resolve o overflow sem biblioteca externa.
